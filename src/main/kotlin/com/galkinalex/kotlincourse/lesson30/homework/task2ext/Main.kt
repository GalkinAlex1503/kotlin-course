...
fun chooseCoffee(client: CharacterTypes) = client.favoriteCoffee


fun main() {
    val semen = CharacterTypes.CTO
    println("For ${semen.name} i offer ${chooseCoffee(semen).description()}")

    val juliya = CharacterTypes.QA
    println("For ${juliya.name} i offer ${chooseCoffee(juliya).description()}")
